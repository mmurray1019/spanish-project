    ...
    if (game.ask("Entras?")) {
        if (done1 == 0) {
            ...
            story.startCutscene(function () {
                ...
                Speech = textsprite.create("Es la exposition?", 12, 1)
                ...
                Speech.setText("Si. Muchas cosas")
                pause(5000)
...
function _4cat_cutscene () {
    ...
    story.startCutscene(function () {
        ...
        pause(2000)
        Speech.setText("Veo personas corriendo con ")
...
scene.onOverlapTile(SpriteKind.player_2d, assets.tile`Ring_L`, function (sprite, location) {
    ...
    if (fight == 0) {
        story.startCutscene(function () {
            ...
            pause(5000)
            Speech.setText("Personas corren enfrente ")
            Speech_line_2 = textsprite.create("de los toros.", 12, 1)
...
scene.onOverlapTile(SpriteKind.Player, sprites.castle.tileGrass2, function (sprite, location) {
    ...
    story.startCutscene(function () {
        ...
        Speech_line_2.setStayInScreen(true)
        pause(5000)
        Speech.setText("Muchos personas murieron.")
...
story.startCutscene(function () {
    Render.setViewMode(ViewMode.tilemapView)
    game.splash("Paula", "La Exposition esta aqui?")
    game.splash("Luis", "Si. La exposition esta en Paris.")
