...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile6`, function (sprite, location) {
    ...
    if (game.ask("Enter?")) {
        ...
        tiles.placeOnRandomTile(player_3D, assets.tile`myTile41`)
    }
})
...
function pavillion () {
    ...
    tiles.placeOnRandomTile(player_3D, assets.tile`myTile5`)
    scene.setBackgroundImage(assets.image`Blank_Background`)
    tiles.placeOnRandomTile(Player2d, assets.tile`myTile40`)
}
...
scene.onOverlapTile(SpriteKind.player_2d, assets.tile`myTile39`, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`Blank_map`)
    if (game.ask("Exit?")) {
        _3Dify()
        tiles.placeOnRandomTile(player_3D, assets.tile`myTile41`)
